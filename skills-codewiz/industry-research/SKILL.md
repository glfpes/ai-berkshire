...
description: 从投资逻辑链出发做行业产业链全景研究：验证逻辑链、绘制产业链图、扫描全球上市公司、对头部公司做四大师分析、给出行业配置建议。当用户要求「研究某行业/产业链/industry-research 某行业」时使用。输出 reports/{行业名}-industry-{YYYYMMDD}.md。
---
