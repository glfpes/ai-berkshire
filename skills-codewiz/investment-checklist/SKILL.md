...
description: 用巴菲特买入前六关 Checklist（能力圈/好生意/护城河/管理层/安全边际等）快速筛选一家或多家公司，10 分钟给出通过/不通过/灰色。当用户要求「过一遍清单/checklist/快速判断某几家公司能不能买」或输入用逗号分隔的多家公司时使用。输出 reports/{公司名}-checklist-{YYYYMMDD}.md。
---
