...
description: 为一家公司撰写 8 篇（约 12 万字）教科书级深度长文系列，用于公众号/视频号公开发布，核心是严格事实核查与「会改」。当用户要求「写 XX 公司深度系列/8 篇长文/看懂 XX 系列/deep-company-series」时使用。输出 reports/{公司名}/《看懂XX》/ 目录。
---
