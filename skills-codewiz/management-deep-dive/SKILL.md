...
description: 对公司管理层/创始人做纵深研究：承诺vs兑现、资本配置回报、困难期决策见品格。当用户要求「深挖管理层/研究某创始人/management-deep-dive 某公司 或 某人名 某公司」，或标准投研中管理层评分不确定时使用。输出 reports/{公司名}-management-{YYYYMMDD}.md。
---
