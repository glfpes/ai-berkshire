...
description: 对未上市公司（如蚂蚁/小红书/SpaceX/Stripe）做多 Agent 并行深度研究，在信息稀缺下还原真实价值（融资轮次/可比公司/情景推演）。当用户要求「研究某未上市公司/一级市场公司/private-company-research 某公司」时使用。输出 reports/{公司名}-private-{YYYYMMDD}.md。
---
