...
description: 从「研究公司」升级到「管理组合」：审视仓位、资金来源、相关性、机会成本，给出组合优化建议。当用户提供持仓清单（如 腾讯30% 美团20% 现金15%）要求「组合审视/仓位建议/portfolio-review」时使用。输出/更新 reports/portfolio-latest.md。
---
