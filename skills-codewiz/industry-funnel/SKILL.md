...
description: 对一个行业/方向做漏斗式选股：从全市场逐层过滤故事股，精选到 3 家终选标的，每层有明确留弃标准。当用户说出一个行业/方向（如 AI 算力、创新药、机器人）想「精选标的/漏斗筛选/industry-funnel」时使用。输出 reports/{行业名}-funnel-{YYYYMMDD}.md。
---
